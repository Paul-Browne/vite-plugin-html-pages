...
export declare function defineStaticParams<T extends () => StaticParams | Promise<StaticParams>>(fn: T): T;
export declare function definePageModule<TParams = PageParams, TData = unknown>(mod: PageModule<TParams, TData>): PageModule<TParams, TData>;
